...
Na początku dostajemy trzy rożne estymatory: 
```{r}
n <- 5000
sigma <- 2
...
Obliczając błędy sredniokwadratowe, dostajemy najmniejszy błąd dla $\hat{S}_1^2$
```{r}
...
**Rozwiązanie zadania 3:**
Dlatego żeby zbadać obciązenie musimy powtórzyć nasz eksperyment ustaloną liczbę razy: 
```{r}
